...
Nous conservons ces 2 améliorations car les mesures de consommation énergétique ne montrent aucune dégradation notable. L'ajout des producteurs locaux renforce notre impact écosystémique en valorisant les commerces de proximité au delà de l'application elle-même. L'amélioration CSS, quant à elle, améliore l'expérience utilisateur en rendant l'information plus lisible et accessible, permettant aux utilisateurs de trouver rapidement ce qu'ils cherchent sans surcharge cognitive. 

## Bilan et perspectives

De ce projet, nous retenons plusieurs enseignements majeurs.

**L'impact environnemental réel des projets informatiques** : bien que conscients que l'informatique impacte l'environnement, nous n'avions pas la conscience précise des ordres de grandeur impliqués. Une découverte contre intuitive s'est imposée lors de notre étude : la consommation énergétique des applications web ne provient pas principalement du serveur ou du processeur, mais de **l'affichage à l'écran de l'utilisateur final**. Cela signifie que l'optimisation écologique doit se concentrer non seulement sur les calculs serveur et les transferts réseau, mais aussi sur la durée et l'efficacité de l'affichage. Grâce aux outils de mesure utilisés (EcoIndex, GreenFrame) et à l'automatisation via GitHub Actions, nous avons pu quantifier précisément ces impacts et identifier les véritables leviers d'optimisation. De plus, les requêtes réseau posent aussi un gros problème : chaque transmission de données consomme de l'énergie, et le volume transféré dépend directement de nos choix de conception. EcoFood a démontré qu'une stratégie de requêtes minimalistes ciblant uniquement les données nécessaires, limitant le nombre d'appels par pagination, et évitant les chargements inutiles peut réduire cette consommation de 98%. Cette réalité a profondément influencé nos décisions architecturales, du choix de CouchDB comme base de données aux stratégies de caching côté client. 

**L'acquisition de technologies innovantes** : ce projet nous a permis de découvrir et d'évaluer diverses approches techniques, notamment l'utilisation de CouchDB comme base de données NoSQL et l'intégration continue via GitHub Actions. Ces découvertes se sont révélées décisives pour atteindre nos objectifs écologiques. CouchDB, en particulier, nous a permis de mettre en place une stratégie de requêtes ciblées : au lieu de charger l'ensemble des données puis de les filtrer côté client, nous récupérons uniquement les champs et enregistrements nécessaires à chaque affichage. Cette approche a réduit la consommation réseau de 98% et transformé la page de sélection de produits d'un problème sérieux (score C) en une solution maîtrisée. GitHub Actions a automatisé notre processus de mesure : chaque intégration déclenche automatiquement une nouvelle évaluation EcoIndex, nous permettant de détecter immédiatement l'impact écologique de chaque modification de code. Cette boucle de rétroaction continue a été transformatrice sans elle, nous aurions pu introduire des régressions sans nous en apercevoir. Ces découvertes élargissent nos perspectives lors de la conception de futurs projets et nous ont montré que l'éco-conception ne dépend pas de technologies propriétaires ou complexes, mais plutôt de choix architecturaux réfléchis et d'une instrumentation rigoureuse. Nous avons appris que l'automatisation de la mesure est aussi importante que l'optimisation elle-même.

**Concevoir autrement** : en tant que futurs ingénieurs, cette expérience nous a appris qu'il est possible et nécessaire de concilier fonctionnalité et sobriété numérique. EcoFood a démontré que chaque décision de conception porte une dimension écologique : le refus d'une carte interactive au profit d'une liste déroulante, l'utilisation du CSS natif plutôt que des frameworks lourds, la limitation à 4 résultats par défaut plutôt que un chargement infini toutes ces choix réduisent l'impact énergétique tout en améliorant l'expérience utilisateur. Cette synergie est cruciale : pour les personnes en situation de précarité alimentaire, un site rapide et direct est plus utile qu'une application graphiquement riche mais lente. L'éco-conception n'est donc pas une contrainte réductrice qui nous force à abandonner les fonctionnalités, c'est une opportunité de créer des solutions alignées avec les véritables besoins des utilisateurs. Elle nous apprend à questionner chaque ligne de code, chaque bibliothèque, chaque requête réseau non pas par purisme, mais par respect de l'environnement. En tant que futurs acteurs de la transformation numérique, nous avons la responsabilité de démontrer que la sobriété énergétique est compatible avec l'innovation et la pertinence. 

### Une application utile
Ce n'a pas été un énième projet avec un objectif purement théorique, il s'agit d'une vraie idée avec un vrai impact social. EcoFood répond à une problématique concrète : **43% des étudiants vivent en situation de précarité alimentaire**. Nos choix techniques ne servent donc pas qu'à optimiser les performances, ils rendent le service plus accessible et viable économiquement pour les populations précaires qu'il sert. C'est un projet où la responsabilité écologique, l'excellence technique et l'impact humain convergent vers un même objectif : offrir à chacun l'accès à l'information pour faire des choix alimentaires informés. 

### Une mise en situation
Ce projet nous a confrontés à des réalités économiques concrètes. Au-delà de la technique et de l'écologie, nous avons dû évaluer les besoins financiers réels et concevoir un modèle économique viable et crédible. Réfléchir à ces enjeux nous a placés face aux défis que rencontrent toutes les startups et projets sociaux : comment financer une solution utile sans compromettre sa mission ?
Cette exercice nous a enseigné que l'innovation technique et l'impact social ne suffisent pas. Un projet durable doit aussi être économiquement viable. En explorant différents modèles de financement, dons, financement public, partenariats commerciaux, nous avons découvert qu'il n'existe pas de solution unique, mais plutôt un équilibre à trouver entre viabilité financière, crédibilité auprès des parties prenantes et alignement avec nos valeurs. 